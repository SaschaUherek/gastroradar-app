...
<header class="app-header">
  <div class="header-top">
    <h1 class="app-title">
      <!-- <?= htmlspecialchars($appName) ?><?= $appCity ? ' · ' . htmlspecialchars($appCity) : '' ?> -->
      <?= htmlspecialchars($appName) ?>
      <a href="search.php" class="search-link" title="Events durchsuchen">
        🔍
      </a>
    </h1>
    ...
    <div class="header-badges">
      <?php if ($manyEvents): ?>
        <span class="week-alert">🔥 Viele Events</span>
      <?php endif; ?>

      <?php if ($rbThisWeek): ?>
        <span class="week-alert rb-alert">⚽ RB Heimspiel</span>
      <?php endif; ?>
  ...
  <nav class="week-nav">
    <?php if ($weekOffset > 0): ?>
      <a href="?week=<?= $weekOffset - 1 ?>" class="nav-btn">‹ vorige</a>
    <?php else: ?>
      <span></span>
    <?php endif; ?>
    ...
    <a href="?week=<?= $weekOffset + 1 ?>" class="nav-btn">nächste ›</a>
  </nav>
