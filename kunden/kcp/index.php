...
<!-- TEST -->
 <?php
$customer = basename(__DIR__);
$config   = gr_get_customer_config($customer); // oder wie deine Funktion heißt
?>
...
">
  DEBUG · customer=<?= htmlspecialchars($customer) ?>
  <?php if (!empty($config['test'])): ?>
    · <?= htmlspecialchars($config['test']) ?>
  <?php endif; ?>
</div>
<!-- TEST ENDE -->
